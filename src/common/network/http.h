...
public:
	...
	std::pair<ReqCode, nlohmann::json> do_POST_sync(const std::string& URL, const nlohmann::json& body,
	                                                const nlohmann::json& headers = {});
	std::pair<ReqCode, nlohmann::json> do_GET_sync(const std::string& URL, const nlohmann::json& body,
	                                               const nlohmann::json& headers = {});
